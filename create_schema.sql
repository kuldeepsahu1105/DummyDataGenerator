...
ROW FORMAT SERDE 'org.apache.hive.hcatalog.data.JsonSerDe'
STORED AS TEXTFILE
LOCATION 's3a://${s3_bucket_name}/user/ksahu/CBS/account/';
...
ROW FORMAT SERDE 'org.apache.hive.hcatalog.data.JsonSerDe'
STORED AS TEXTFILE
LOCATION 's3a://${s3_bucket_name}/user/ksahu/HRMS/employee/';
...
ROW FORMAT SERDE 'org.apache.hive.hcatalog.data.JsonSerDe'
STORED AS TEXTFILE
LOCATION 's3a://${s3_bucket_name}/user/ksahu/HRMS/timetracking/';
